```{r GenerateTitle, echo=FALSE, results='asis'}
writeTitleInfo <- function(plTitleInfo){
  cat("---\n")
  for (n in c("title","author", "date","output")){
    cat(n, ": \"", plTitleInfo[[n]], "\"\n", sep = "")
  }
  cat("---\n")
}
# get title info from function
lTitleInfo <- lGetTitleInfo()
writeTitleInfo(plTitleInfo = lTitleInfo)
```
